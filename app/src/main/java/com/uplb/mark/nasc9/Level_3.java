...
public class Level_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question_1_button = findViewById(R.id.l3_q1_button);
        if (db_CRUD.isAnswered(20))
        {
            question_1_button.setBackgroundResource(R.drawable.l1_q1_done);
        }
        question_1_button.setOnTouchListener(l3_q1_touch);


        question_2_button = findViewById(R.id.l3_q2_button);
        if (db_CRUD.isAnswered(21))
        {
            question_2_button.setBackgroundResource(R.drawable.l1_q2_done);
        }
        question_2_button.setOnTouchListener(l3_q2_touch);


        question_3_button = findViewById(R.id.l3_q3_button);
        if (db_CRUD.isAnswered(22))
        {
            question_3_button.setBackgroundResource(R.drawable.l1_q3_done);
        }
        question_3_button.setOnTouchListener(l3_q3_touch);


        question_4_button = findViewById(R.id.l3_q4_button);
        if (db_CRUD.isAnswered(23))
        {
            question_4_button.setBackgroundResource(R.drawable.l1_q4_done);
        }
        question_4_button.setOnTouchListener(l3_q4_touch);


        question_5_button = findViewById(R.id.l3_q5_button);
        if (db_CRUD.isAnswered(24))
        {
            question_5_button.setBackgroundResource(R.drawable.l1_q5_done);
        }
        question_5_button.setOnTouchListener(l3_q5_touch);


        question_6_button = findViewById(R.id.l3_q6_button);
        if (db_CRUD.isAnswered(25))
        {
            question_6_button.setBackgroundResource(R.drawable.l1_q6_done);
        }
        question_6_button.setOnTouchListener(l3_q6_touch);


        question_7_button = findViewById(R.id.l3_q7_button);
        if (db_CRUD.isAnswered(26))
        {
            question_7_button.setBackgroundResource(R.drawable.l1_q7_done);
        }
        question_7_button.setOnTouchListener(l3_q7_touch);


        question_8_button = findViewById(R.id.l3_q8_button);
        if (db_CRUD.isAnswered(27))
        {
            question_8_button.setBackgroundResource(R.drawable.l1_q8_done);
        }
        question_8_button.setOnTouchListener(l3_q8_touch);


        question_9_button = findViewById(R.id.l3_q9_button);
        if (db_CRUD.isAnswered(28))
        {
            System.out.println("ANSWERED CORRECTLY");
            question_9_button.setBackgroundResource(R.drawable.l1_q9_done);
        }
        question_9_button.setOnTouchListener(l3_q9_touch);


        question_10_button = findViewById(R.id.l3_q10_button);
        if (db_CRUD.isAnswered(29))
        {
            question_10_button.setBackgroundResource(R.drawable.l1_q10_done);
        }
        question_10_button.setOnTouchListener(l3_q10_touch);

        question_home_button = findViewById(R.id.l3_home_button);
        question_home_button.setOnTouchListener(l3_home_touch);
    }

    View.OnTouchListener l3_home_touch = new View.OnTouchListener()
    {
        @Override
    ...
    View.OnTouchListener l3_q1_touch = new View.OnTouchListener()
    {

        @Override
        public boolean onTouch(View view, MotionEvent motionEvent) {
            question_1_button.setBackgroundResource(R.drawable.l1_q1_down);
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 20);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q2_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 21);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q3_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 22);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q4_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 23);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q5_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 24);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q6_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 25);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q7_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 26);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q8_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 27);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q9_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 28);
            startActivity(q1_intent);
            return true;
        }
    };

    View.OnTouchListener l3_q10_touch = new View.OnTouchListener()
    {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            Intent q1_intent = new Intent(Level_3.this, MultipleChoice.class);
            q1_intent.putExtra("QUESTION_ID", 29);
            startActivity(q1_intent);
            return true;
        }
    };
